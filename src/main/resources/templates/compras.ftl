						...
						<div class="panel-body">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <#list productos as producto>
                                                                    <option value="${producto.getId()}">${producto.getNombreEquipo()}</option>
                                                                </#list>
                                                                </select>
                            ...
                            <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">${alquiler.getProducto().getNombreEquipo()}</td>
                                    <td class="text-center">${alquiler.getEstado()}</td>
                                    <td>

                                        <div class="btn-group">
                                            <div class="btn-group">
                                                <form action="/compras/entregado/${alquiler.getId()}" method="GET">
                                                    <button type="submit" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                                </form>
                                            </div>
                                            <div class="btn-group">
                                                <form action="/compras/eliminar/${alquiler.getId()}" method="POST">
...
<script>
    ...
    var imgs=[];
     ...
     <#list productos as producto>
            ...
            nombre.push('${producto.getNombreEquipo()}');
